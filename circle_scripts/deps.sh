...
export AND_AS="$_toolchain_/arm-linux-androideabi/bin/arm-linux-androideabi-clang"
...
export AND_AS="$_toolchain_/$AND_TOOLCHAIN_ARCH/bin/aarch64-linux-android-clang"
...
if [ "$full""x" == "1x" ]; then
    ...
    ln -sf $(which llvm-strip) $_toolchain_/$AND_TOOLCHAIN_ARCH/bin/aarch64-linux-androideabi-strip
...
export AND_AS="$_toolchain_/x86/bin/i686-linux-android-clang"
...
if [ "$full""x" == "1x" ]; then
    ...
    ln -sf $(which llvm-strip) $_toolchain_/$AND_TOOLCHAIN_ARCH/bin/i686-linux-androideabi-strip
...
export AND_AS="$_toolchain_/$AND_TOOLCHAIN_ARCH/bin/x86_64-linux-android-clang"
...
if [ "$full""x" == "1x" ]; then
    ...
    ln -sf $(which llvm-strip) $_toolchain_/$AND_TOOLCHAIN_ARCH/bin/x86_64-linux-androideabi-strip

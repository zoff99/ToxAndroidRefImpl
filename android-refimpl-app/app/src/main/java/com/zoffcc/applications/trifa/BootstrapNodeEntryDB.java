...
public class BootstrapNodeEntryDB
{
    ...
    public static void insert_default_tcprelay_nodes_into_db()
    {
        ...
        int num_ = 0;
        // @formatter:off
        n = BootstrapNodeEntryDB_(false, num_, "85.143.221.42",3389,"DA4E4ED4B697F2E9B000EEFE3A34B554ACD3F45F5C96EAEA2516DD7FF9AF7B43");insert_node_into_db_real(n);num_++;
        n = BootstrapNodeEntryDB_(false, num_, "tox.verdict.gg",3389,"1C5293AEF2114717547B39DA8EA6F1E331E5E358B35F9B6B5F19317911C5F976");insert_node_into_db_real(n);num_++;
        n = BootstrapNodeEntryDB_(false, num_, "78.46.73.141",33445,"02807CF4F8BB8FB390CC3794BDF1E8449E9A8392C5D3F2200019DA9F1E812E46");insert_node_into_db_real(n);num_++;
        ...
        n = BootstrapNodeEntryDB_(false, num_, "195.123.208.139",33445,"534A589BA7427C631773D13083570F529238211893640C99D1507300F055FE73");insert_node_into_db_real(n);num_++;

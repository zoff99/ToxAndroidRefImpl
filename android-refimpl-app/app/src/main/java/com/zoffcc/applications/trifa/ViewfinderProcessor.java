...
public class ViewfinderProcessor
{
    ...
    public ViewfinderProcessor(RenderScript rs, Size dimensions)
    {
        ...
        mInputHdrAllocation = Allocation.createTyped(rs, yuvTypeBuilder.create(), Allocation.USAGE_IO_INPUT | Allocation.USAGE_SCRIPT);
        ...
        mPrevAllocation = Allocation.createTyped(rs, rgbTypeBuilder.create(), Allocation.USAGE_SCRIPT);

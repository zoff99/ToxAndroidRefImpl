...
the project to specify:
    ...
    dependencyVerification {
        verify = [
                'com.actionbarsherlock:actionbarsherlock:4.4.0:actionbarsherlock-4.4.0.aar:5ab04d74101f70024b222e3ff9c87bee151ec43331b4a2134b6cc08cf8565819',
                'com.android.support:support-v4:19.0.1:support-v4-19.0.1.jar:a4268abd6370c3fd3f94d2a7f9e6e755f5ddd62450cf8bbc62ba789e1274d585',
                'com.google.android.gcm:gcm-client:1.0.2:gcm-client-1.0.2.jar:5ff578202f93dcba1c210d015deb4241c7cdad9b7867bd1b32e0a5f4c16986ca',
                'se.emilsjolander:stickylistheaders:2.2.0:stickylistheaders-2.2.0.jar:89146b46c96fea0e40200474a2625cda10fe94891e4128f53cdb42375091b9b6',
        ]
    }
...
`verify` with elements in the format of `group_id:name:version:filename:sha256sum`.
...
Dependencies on other projects in the same build, and dependencies that resolve to files within the
project directory, will be skipped automatically. You can also specify dependencies to skip with
the `noWitness` property. This is a comma-separated list of configuration names, optionally
including project names. For example,
`gradle -q calculateChecksums -P noWitness=configA,projectX:configB` will skip dependencies of the
configuration `configA` in all projects and the configuration `configB` in the project `projectX`.
